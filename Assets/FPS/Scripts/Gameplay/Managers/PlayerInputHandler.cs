...
namespace Unity.FPS.Gameplay
{
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        MyVRControllerManager m_VRController;
        ...
        void Start()
        {
            ...
            //------------------------------------------------- custom
            m_VRController = MyVRControllerManager.instance;
            //------------------------------------------------- custom
        }
        ...
        {
            return GetFireInputHeld() && !m_FireInputWasHeld; //--------------------------------- 여길 살짝 수정합시다.
        }
        ...
        public bool GetFireInputHeld()
        {
            ...
            if (CanProcessInput())
            {
                ...
                else if (m_VRController.devAvailable)
                {
                    return m_VRController.devData.btnClick != -1;
                }
                else
                {
        ...
        public int GetSwitchWeaponInput()
        {
            if (CanProcessInput())
            {
                ...
                if (Input.GetAxis(axisName) > 0f)
                    ...
                    return 1;
                else if (Input.GetAxis(GameConstants.k_ButtonNameNextWeapon) > 0f || m_VRController.Shake)
                    return -1;
